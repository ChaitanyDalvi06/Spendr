...
var pt = (a) => a.offsetWidth > 0 && a.offsetHeight > 0;
function mt(a, t, { reverse: e = false } = {}) {
  const i = a.length;
...
function Et(a, t) {
  ...
  let p = "", m = false, P = false;
  for (const c of e) {
    p += c.value;
    const f = c.type === "minusSign" || c.type === "plusSign" ? "sign" : c.type;
    f === "integer" ? (m = true, n.push(...c.value.split("").map((J) => ({ type: f, value: parseInt(J) })))) : f === "group" ? n.push({ type: f, value: c.value }) : f === "decimal" ? (P = true, r.push({ type: f, value: c.value, key: u(f) })) : f === "fraction" ? r.push(...c.value.split("").map((J) => ({
      type: f,
      value: parseInt(J),
      key: u(f),
      place: -1 - o[f]
...
var gt = String.raw;
var wt = F && typeof CSS < "u" && CSS.supports("animation-timing-function", "linear(1,2)");
var yt = F && typeof CSS < "u" && CSS.supports("line-height", "mod(1,1)");
var Q = F ? matchMedia("(prefers-reduced-motion: reduce)") : null;
var Z = "--_number-flow-d-opacity";
var nt = "--_number-flow-d-width";
var q = "--_number-flow-dx";
var at = "--_number-flow-d";
var _t = (() => {
  try {
...
var ht = "var(--number-flow-char-height, 1em)";
var g = "var(--number-flow-mask-height, 0.25em)";
var C = `calc(${g} / 2)`;
var tt = "var(--number-flow-mask-width, 0.5em)";
var S = `calc(${tt} / var(--scale-x))`;
var D = "#000 0, transparent 71%";
var et = "span";
var ot = gt`:host{display:inline-flex;align-items:baseline;direction:ltr;white-space:nowrap;position:relative;line-height:${ht} !important;isolation:isolate;}::slotted(${et}){position:absolute;left:0;top:0;color:transparent !important;will-change:unset !important;z-index:-5;}:host > .number,:host > .section{pointer-events:none;user-select:none;}.number,.number__inner{display:inline-flex;align-items:baseline;transform-origin:left top;}:host([data-will-change]) .number,:host([data-will-change]) .number__inner{will-change:transform;}.number{--scale-x:calc(1 + var(${nt}) / var(--width));transform:translateX(var(${q})) scaleX(var(--scale-x));margin:0 calc(-1 * ${tt});position:relative;z-index:-1;overflow:clip;-webkit-mask-image:linear-gradient( to right,transparent 0,#000 ${S},#000 calc(100% - ${S}),transparent ),linear-gradient( to bottom,transparent 0,#000 ${g},#000 calc(100% - ${g}),transparent 100% ),radial-gradient(at bottom right,${D}),radial-gradient(at bottom left,${D}),radial-gradient(at top left,${D}),radial-gradient(at top right,${D});-webkit-mask-size:100% calc(100% - ${g} * 2),calc(100% - ${S} * 2) 100%,${S} ${g},${S} ${g},${S} ${g},${S} ${g};-webkit-mask-position:center,center,top left,top right,bottom right,bottom left;-webkit-mask-repeat:no-repeat;}.number__inner{padding:0 ${tt};transform:scaleX(calc(1 / var(--scale-x))) translateX(calc(-1 * var(${q})));}.section{display:inline-flex;align-items:baseline;padding-bottom:${C};padding-top:${C};position:relative;isolation:isolate;}.section::after{content:'\200b';display:block;padding:${C} 0;}:host([data-will-change]) .section{will-change:transform;}.section--justify-left{transform-origin:center left;}.section--justify-right{transform-origin:center right;}.section__exiting{position:absolute !important;z-index:-1;}.digit{display:block;position:relative;--c:var(--current) + var(${at});}:host([data-will-change]) .digit,:host([data-will-change]) .digit__num{will-change:transform;}.digit__num{display:block;padding:${C} 0;--offset-raw:mod(10 + var(--n) - mod(var(--c),10),10);--offset:calc(var(--offset-raw) - 10 * round(down,var(--offset-raw) / 5,1));--y:clamp(-100%,var(--offset) * 100%,100%);transform:translateY(var(--y));}.digit__num:not(.is-current){position:absolute;top:0;left:50%;transform:translateX(-50%) translateY(var(--y));}.digit:not(.is-spinning) .digit__num:not(.is-current){display:none;}.symbol{display:inline-flex;align-items:baseline;position:relative;isolation:isolate;padding:${C} 0;}:host([data-will-change]) .symbol{will-change:transform;}.symbol__value{display:block;white-space:pre;}.symbol__exiting{position:absolute;z-index:-1;}.section--justify-left .symbol__exiting{left:0;}.section--justify-right .symbol__exiting{right:0;}.animate-presence{opacity:calc(1 + var(${Z}));}`;
var vt = F ? HTMLElement : class {
};
var Mt = ({ formatted: a, willChange: t }) => `<${et} style="font-kerning: none; display: inline-block; line-height: ${ht}; padding: ${g} 0;${t ? "will-change: transform" : ""}">${a}</${et}>`;
var bt = (a, t) => a != null && t == null ? a : a == null && t != null ? t : a != null && t != null ? Math.max(a, t) : null;
var N;
var B;
var k;
var x;
...
var kt = class extends vt {
  ...
  set parts(t) {
    ...
    if (s(this, B, "f")) {
      const o = s(this, R, "f");
      if (h(this, R, t, "f"), this.trend === true ? h(this, y, Math.sign(l - o.value), "f") : this.trend === "increasing" ? h(this, y, b.UP, "f") : this.trend === "decreasing" ? h(this, y, b.DOWN, "f") : h(this, y, b.NONE, "f"), h(this, U, void 0, "f"), s(this, y, "f") !== b.NONE && this.continuous) {
...
var ct = class {
  ...
  pop(t) {
    t.forEach((e) => {
      ...
      e.el.classList.add("section__exiting"), e.present = false;
    });
  }
  addNewAndUpdateExisting(t) {
    ...
    if (mt(t, (l) => {
      let o;
      this.children.has(l.key) ? (o = this.children.get(l.key), i.set(l, o), this.unpop(o), o.present = true) : (o = this.addChar(l, { startDigitsAtZero: true, animateIn: true }), e.set(l, o)), this.el[r](o.el);
...
var st = class {
  constructor(t, e, { onRemove: i, animateIn: n = false } = {}) {
    this.flow = t, this.el = e, j.set(this, true), I.set(this, void 0), T.set(this, () => {
      var r;
...
var dt = class extends ft {
  ...
  didUpdate(t) {
    ...
    l && (this.el.classList.add("is-spinning"), this.el.animate({
      ...
      composite: "accumulate"
    }), this.flow.addEventListener("animationsfinish", s(this, it, "f"), { once: true }));
  }
  get diff() {
...
var $t = class extends ft {
  ...
  update(t) {
    if (this.value !== t) {
      ...
      if (e.present = false, e.el.classList.add("symbol__exiting"), s(this, v, "f").has(t)) {
        const i = s(this, v, "f").get(t);
        i.present = true, i.el.classList.remove("symbol__exiting");
      } else {
        const i = w("span", {
          className: "symbol__value",
          textContent: t
...
var NumberFlowImpl = class extends React.Component {
  ...
  updateNonPartsProps(prevProps) {
    if (!__privateGet(this, _el))
      return;
    __privateGet(this, _el).manual = !this.props.isolate;
    const [nonParts] = splitProps(this.props);
    Object.assign(
      __privateGet(this, _el),
      Object.fromEntries(Object.entries(nonParts).filter(([_2, v2]) => v2 != null))
    );
    if (prevProps == null ? void 0 : prevProps.onAnimationsStart)
    ...
    if (prevProps == null ? void 0 : prevProps.onAnimationsFinish)
  ...
  getSnapshotBeforeUpdate(prevProps) {
    ...
    if (this.props.isolate || this.props.animated === false || prevProps.parts === this.props.parts)
      return false;
    (_a = __privateGet(this, _el)) == null ? void 0 : _a.willUpdate();
    return true;
  }
  componentDidUpdate(_2, __, snapshot) {
    var _a;
    if (snapshot)
      (_a = __privateGet(this, _el)) == null ? void 0 : _a.didUpdate();
  }
  handleRef(el) {
  ...
  render() {
    const [_2, { innerRef, className, parts, willChange, isolate, ...rest }] = splitProps(this.props);
    return (
      ...
      React.createElement(
        "number-flow",
        {
          ...
          class: className,
          ...rest,
          dangerouslySetInnerHTML: { __html: Mt({ formatted: parts.formatted, willChange }) },
...
var NumberFlow = React.forwardRef(function NumberFlow2({ value, locales, format, ...props }, _ref) {
  ...
  const parts = React.useMemo(() => {
    var _a;
    const formatter = formatters[_a = `${localesString}:${formatString}`] ?? (formatters[_a] = new Intl.NumberFormat(
      locales,
      format
    ));
    return Et(value, formatter);
  }, [value, localesString, formatString]);
  return React.createElement(NumberFlowImpl, { ...props, parts, innerRef: ref });
});
var src_default = NumberFlow;
function useCanAnimate({ respectMotionPreference = true } = {}) {
  const [canAnimate, setCanAnimate] = React.useState(St);
  const [reducedMotion, setReducedMotion] = React.useState(false);
  React.useEffect(() => {
    var _a;
    setCanAnimate(St);
    setReducedMotion(((_a = Q) == null ? void 0 : _a.matches) ?? false);
  }, []);
  React.useEffect(() => {
    var _a;
    ...
    (_a = Q) == null ? void 0 : _a.addEventListener("change", onChange);
    return () => {
      var _a2;
      (_a2 = Q) == null ? void 0 : _a2.removeEventListener("change", onChange);
    };
  }, [respectMotionPreference]);
